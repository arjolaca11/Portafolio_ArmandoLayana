...
// mapea la tabla "producto" (ver creaTablas.sql)
@Data
@Entity
@Table(name = "producto")
public class Producto implements Serializable {
    ...
    // el atributo idCategoria no se usa, esta implicito en el objeto categoria (ver @ManyToOne)
    // se excluye de toString/equals/hashCode para evitar recursion con Categoria.productos
    @ToString.Exclude
